...
public class SignUpPage extends BasePage {
    ...
    public SignUpPage enterData(String firstName, String lastName, String email, String password, Boolean checkbox) { // метод в котором все методы необходимые для ввода
